...
#include "SoldierTypes.generated.h"

namespace ESoldierMatchState
{
	enum Type
	{
		Warmup,
...
namespace ESoldierCrosshairDirection
{
	enum Type
	{
		Left=0,
...
/** keep in sync with SoldierImpactEffect */
UENUM()
namespace ESoldierPhysMaterialType
{
	enum Type
	{
		Unknown,
...
struct FTakeHitInfo
{
	...
	/** Who hit us */
	UPROPERTY()
	TWeakObjectPtr<class ASoldierCharacter> PawnInstigator;
