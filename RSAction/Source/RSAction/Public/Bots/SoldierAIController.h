...
UCLASS(config=Game)
class ASoldierAIController : public AAIController
{
...
public:
	...
	void CheckAmmo(const class ASoldierWeapon* CurrentWeapon);

	void SetEnemy(class APawn* InPawn);

	class ASoldierCharacter* GetEnemy() const;
	...
	UFUNCTION(BlueprintCallable, Category = Behavior)
	bool FindClosestEnemyWithLOS(ASoldierCharacter* ExcludeEnemy);
...
protected:
	...
	bool LOSTrace(ASoldierCharacter* InEnemyChar) const;
