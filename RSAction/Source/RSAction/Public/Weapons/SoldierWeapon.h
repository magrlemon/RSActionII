...
class ASoldierWeapon : public AActor
{
	...
	virtual void OnEnterInventory(ASoldierCharacter* NewOwner);
	...
	class ASoldierCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(ASoldierCharacter* ASoldierCharacter);
...
protected:
	...
	class ASoldierCharacter* MyPawn;
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(ASoldierWeapon::FireWeapon,);
