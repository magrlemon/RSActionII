...
#include "SoldierWeapon_Instant.generated.h"

class ASoldierImpactEffect;
...
UCLASS(Abstract)
class ASoldierWeapon_Instant : public ASoldierWeapon
{
...
protected:
	...
	TSubclassOf<ASoldierImpactEffect> ImpactTemplate;
