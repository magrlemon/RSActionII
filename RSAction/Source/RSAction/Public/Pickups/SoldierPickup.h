...
#include "SoldierPickup.generated.h"

// Base class for pickup objects that can be placed in the world
UCLASS(abstract)
class ASoldierPickup : public AActor
{
	...
	virtual bool CanBePickedUp(class ASoldierCharacter* TestPawn) const;
...
protected:
	...
	/** give pickup */
	virtual void GivePickupTo(class ASoldierCharacter* Pawn);

	/** handle touches */
	void PickupOnTouch(class ASoldierCharacter* Pawn);
