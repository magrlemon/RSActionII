...
#include "SoldierActControllerBase.generated.h"

// Based on LOGIN_REQUIRED_FOR_ONLINE_PLAY in SoldierMainMenu.cpp
#if PLATFORM_SWITCH
...
UCLASS()
class USoldierActControllerBase : public UGauntletTestController, public TSharedFromThis<USoldierActControllerBase>
{
	GENERATED_BODY()
...
protected:
	...
	// Helper Functions
	virtual USoldierGameInstance* GetGameInstance() const;
	virtual const FName GetGameInstanceState() const;
	virtual ASoldierGameSession* GetGameSession() const;
