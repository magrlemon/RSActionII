...
UCLASS(config=Game)
class ASoldierGameMode : public AGameMode
{
	...
	virtual bool CanDealDamage(ASoldierPlayerState* DamageInstigator, ASoldierPlayerState* DamagedPlayer) const;
...
public:	
	...
	UPROPERTY()
	TArray<ASoldierPickup*> LevelPickups;
