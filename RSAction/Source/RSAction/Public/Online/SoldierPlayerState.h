...
UCLASS()
class ASoldierPlayerState : public APlayerState
{
	...
	void ScoreKill(ASoldierPlayerState* Victim, int32 Points);

	/** player died */
	void ScoreDeath(ASoldierPlayerState* KilledBy, int32 Points);
	...
	void InformAboutKill(class ASoldierPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class ASoldierPlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
	void BroadcastDeath(class ASoldierPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class ASoldierPlayerState* KilledPlayerState);
