...
UCLASS(config=Game)
class RSACTION_API ASoldierGameSession : public AGameSession
{
...
protected:
	...
	FSoldierGameSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FSoldierOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FSoldierOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ASoldierGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ASoldierGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(ASoldierGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(ASoldierGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
