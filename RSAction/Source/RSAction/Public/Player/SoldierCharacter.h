...
class ASoldierCharacter : public ACharacter
{
	...
	*/
	void AddWeapon(class ASoldierWeapon* Weapon);
	...
	*/
	void RemoveWeapon(class ASoldierWeapon* Weapon);
	...
	*/
	class ASoldierWeapon* FindWeapon(TSubclassOf<class ASoldierWeapon> WeaponClass);
	...
	*/
	void EquipWeapon(class ASoldierWeapon* Weapon);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Game|Weapon")
	class ASoldierWeapon* GetWeapon() const;

	/** Global notification when a character equips a weapon. Needed for replication graph. */
	RSACTION_API static FOnSoldierCharacterEquipWeapon NotifyEquipWeapon;

	/** Global notification when a character un-equips a weapon. Needed for replication graph. */
	RSACTION_API static FOnSoldierCharacterUnEquipWeapon NotifyUnEquipWeapon;
	...
	*/
	class ASoldierWeapon* GetInventoryWeapon(int32 index) const;
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = Inventory)
	TArray<TSubclassOf<class ASoldierWeapon> > DefaultInventoryClasses;

	/** weapons in inventory */
	UPROPERTY(Transient, Replicated)
	TArray<class ASoldierWeapon*> Inventory;

	/** currently equipped weapon */
	UPROPERTY(Transient, ReplicatedUsing = OnRep_CurrentWeapon)
	class ASoldierWeapon* CurrentWeapon;
...
protected:
	...
	void ServerEquipWeapon(class ASoldierWeapon* NewWeapon);
