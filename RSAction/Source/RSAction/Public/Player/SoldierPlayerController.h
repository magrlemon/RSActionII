...
UCLASS(config=Game)
class ASoldierPlayerController : public APlayerController
{
...
// 	virtual void Emote(const FString& Msg);
	...
	// begin ASoldierPlayerController-specific
	...
	ASoldierHUD* GetSoldierHUD() const;
...
protected:
	...
	TSharedPtr<class FSoldierIngameMenu> SoldierIngameMenu;
...
public:
	...
	float SoldierFriendUpdateTimer;
