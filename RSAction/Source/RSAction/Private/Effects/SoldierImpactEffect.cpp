...
void ASoldierImpactEffect::PostInitializeComponents()
{
...
UParticleSystem* ASoldierImpactEffect::GetImpactFX(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
...
USoundCue* ASoldierImpactEffect::GetImpactSound(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
