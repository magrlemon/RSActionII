...
#include "SoldierReplicationGraph.generated.h"
...
{
	NotRouted,						// Doesn't map to any node. Used for special case actors that handled by special case nodes (USoldierReplicationGraphNode_PlayerStateFrequencyLimiter)
	RelevantAllConnections,			// Routes to an AlwaysRelevantNode or AlwaysRelevantStreamingLevelNode node
	
	// ONLY SPATIALIZED Enums below here! See USoldierReplicationGraph::IsSpatialized
...
/** SoldierGame Replication Graph implementation. See additional notes in SoldierReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class USoldierReplicationGraph :public UReplicationGraph
{
	GENERATED_BODY()

public:

	USoldierReplicationGraph();
	...
	void OnCharacterEquipWeapon(ASoldierCharacter* Character, ASoldierWeapon* NewWeapon);
	void OnCharacterUnEquipWeapon(ASoldierCharacter* Character, ASoldierWeapon* OldWeapon);
...
UCLASS()
class USoldierReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode
{
	GENERATED_BODY()
...
UCLASS()
class USoldierReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
