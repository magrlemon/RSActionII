...
{
	SoldierHUDPCTrackerBase::Init(InContext);

	ChatStyle = &FSoldierStyle::Get().GetWidgetStyle<FSoldierChatStyle>("DefaultSoldierChatStyle");
	...
	ChatFont = FSoldierStyle::Get().GetFontStyle("SoldierGame.ChatFont");
