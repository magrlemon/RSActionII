...
class FSoldierFriends : public TSharedFromThis<FSoldierFriends>
{
public:
	...
	TSharedPtr<FSoldierMenuItem> FriendsItem;
	...
	/** delegate, which is executed by SSoldierMenuWidget if facebutton_left is pressed */
...
protected:
	...
	const struct FSoldierOptionsStyle *FriendsStyle;
};