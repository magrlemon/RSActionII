...
#include "Widgets/SSoldierServerList.h"
#include "Widgets/SSoldierDemoList.h"
#include "Widgets/SSoldierLeaderboard.h"
#include "Widgets/SSoldierOnlineStore.h"
...
protected:
	...
	TSharedPtr<class SSoldierSplitScreenLobby> SplitScreenLobbyWidget;

	/* used for removing the SplitScreenLobby */
	TSharedPtr<class SWeakWidget> SplitScreenLobbyWidgetContainer;

	/** server list widget */
	TSharedPtr<class SSoldierServerList> ServerListWidget;

	/** demo list widget */
	TSharedPtr<class SSoldierDemoList> DemoListWidget;

	/** leaderboard widget */
	TSharedPtr<class SSoldierLeaderboard> LeaderboardWidget;

	/** online store widget */
	TSharedPtr<class SSoldierOnlineStore> OnlineStoreWidget;

	/** custom menu */
	TSharedPtr<class FSoldierMenuItem> JoinServerItem;

	/** yet another custom menu */
	TSharedPtr<class FSoldierMenuItem> LeaderboardItem;

	/** yet another custom menu */
	TSharedPtr<class FSoldierMenuItem> OnlineStoreItem;
	...
	/** Record demo option */
	TSharedPtr<class FSoldierMenuItem> RecordDemoItem;
	...
	TSharedPtr<FSoldierMenuItem> HostOfflineMapOption;
	TSharedPtr<FSoldierMenuItem> HostOnlineMapOption;
	TSharedPtr<FSoldierMenuItem> JoinMapOption;

	/** Host an onine session menu */
	TSharedPtr<FSoldierMenuItem> HostOnlineMenuItem;
	...
	void BotCountOptionChanged(TSharedPtr<FSoldierMenuItem> MenuItem, int32 MultiOptionIndex);			
	...
	void RecordDemoChanged(TSharedPtr<FSoldierMenuItem> MenuItem, int32 MultiOptionIndex);
	...
	TSharedPtr<class SSoldierConfirmationDialog> QuickMatchFailureWidget;
	...
	TSharedPtr<class SSoldierConfirmationDialog> QuickMatchSearchingWidget;
	...
	TSharedPtr<class SSoldierConfirmationDialog> QuickMatchStoppingWidget;
