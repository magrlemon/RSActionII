...
class FSoldierWelcomeMenu : public TSharedFromThis<FSoldierWelcomeMenu>
{
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class URSActionGameInstance > InGameInstance );
	...
	TWeakObjectPtr< class URSActionGameInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class URSActionGameInstance > GameInstance;
